...
public class MessageStatusUpdateAction extends ActionService {
   ...
   public MessageStatusUpdateAction(
   ...
   public void handleMessage(JsonNode jsonNode) throws Exception {
      ...
      String messageStatusType = jsonNode.has("messageStatusType")
         ? jsonNode.get("messageStatusType").asText()
         : null;
      Long userId = jsonNode.has("userId")
         ? jsonNode.get("userId").asLong()
         : null;
      Long conversationId = jsonNode.has("conversationId")
