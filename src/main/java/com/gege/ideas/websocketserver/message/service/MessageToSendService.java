...
public class MessageToSendService {
    ...
    @Autowired
    public MessageToSendService(MessageToSendRepository messageToSendRepository) {
    ...
    public void markMessageAsDelivered(Long messageId, Long userId) {
        ...
        MessageToSend message = messageToSendRepository.findByMessageIdAndUserId(messageId, userId);
