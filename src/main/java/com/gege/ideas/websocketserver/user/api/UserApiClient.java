...
public class UserApiClient {
    ...
    @Autowired
    public UserApiClient(RestTemplate restTemplate, SystemAuthTokenProvider authTokenProvider, ApiProperties apiProperties) {
    ...
    public User getUserByToken(String token) {
        try {
            ...
            if (response.getStatusCode() == HttpStatus.OK && response.getBody() != null) {
                ...
                System.err.println("⚠️ Failed to fetch user, status: " + response.getStatusCode());
            }
        } catch (Exception e) {
    ...
    public User getUserById(Long id) {
        ...
        try {
            ...
            if (response.getStatusCode() == HttpStatus.OK && response.getBody() != null) {
                ...
                System.err.println("⚠️ Failed to fetch user by ID. Status: " + response.getStatusCode());
            }
